...
export function VisualizerCanvas({
  ...
  return (
    <section className="flex min-h-[22rem] flex-col overflow-hidden rounded-2xl border border-border  shadow-sm">
      ...
      <div className="flex flex-1 items-center justify-center p-5">
        {children ?? (
          <div className="max-w-xs text-center">
            <div className="backdrop-blur-md  mx-auto flex size-12 items-center justify-center rounded-xl border border-primary/30 bg-primary/10 text-primary">
